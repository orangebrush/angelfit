...
extension CoreDataHandler{
    ...
    public func insertDoctorHaSuggestionFeedback(byId id: Int64, byObjectId objectId: Int64, byUserId userId: Int64? = nil) -> DoctorHaSuggestionFeedback?{
    ...
    public func selectAllDoctorHaSuggestionFeedbacks(byObjectId objectId: Int64, byUserId userId: Int64? = nil) -> [DoctorHaSuggestionFeedback]{
    ...
    //MARK:- 删除最后一条feedback
    public func deleteDoctorHaSuggestionFeedback(byAdvisorId advisorId: Int64, byDoctorHaSuggestionId suggestionId: Int64, byObjectId objectId: Int64, byUserId userId: Int64? = nil){
        //判断userId
