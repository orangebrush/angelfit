...
extension CBridgingManager{
    ...
    func createBaseConfigure()  {
        ...
        swiftBleSwitchStart = {
            ...
            AngelSwitchDataManager.share()?.sendSwitchStart(1)
